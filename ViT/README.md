...
img_size = (224, 224), lr = 0.002, and mini_batch_size = 32-128, no augmentatio and all tiles were normalized to the mean and standard deviation of ImageNet dataset.
