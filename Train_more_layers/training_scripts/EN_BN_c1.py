...
def pretrained_model(img_shape, num_classes,layer_type):
    ...
    model_EN_conv.layers[-1].trainable = True   ## This is the main logic for unfreezing deeper layer 
    model_EN_conv.layers[-2].trainable = True   ## Here, we have only unfreeze the Batch normalization layer 
